...
dataAccess.constants = {
    ...
    addNewSpecialty: "/ListManagement/addNewSpecialty",
...
dataAccess.loginService = {
    ...
    markVerified: function (arrayList) {
        ...
        swal({
            title: "Alert",
            text: "Should they be marked verified?",
            type: "info",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            if (Result.Code === "400") {
                                ...
                                //  alert("Record deleted");
                                swal({ title: "Done", text: "Selected users are marked verified.", type: "success", allowEscapeKey: false, allowOutsideClick: false },
                                    function () {
                                        window.location.href = '/User/ManagemenListAndsearch';
                                    }
                                );
...
dataAccess.listManagementService = {
